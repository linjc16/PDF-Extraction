...
PADDLE_OUT_DIR=/home/v-jiachlin/blob2/sptdata/tab_fig_parser/raw_v4/chemrxiv
# PADDLE_OUT_DIR='out_test/raw_v2'
# PADDLE_OUT_DIR=out_t1
# PDF_ROOT_PATH=
PDF_ROOT_PATH=/home/v-jiachlin/blob2/sptdata/paper_collection/chemrxiv/pdf
